...
const ar: Translations = {
  ...
  pixelTerminal: {
    ...
    systemReady:
      "[النظام]: مساعد بكسل جاهز.\n[النظام]: اسألوا عن صياغة البرومبت، Cursor، Replit، تصحيح الأخطاء، أو نشر مشروع Vibe Coding الخاص بكم!",
    placeholder: "اكتبوا سؤالكم (مثال: 'كيف أكتب برومبت جيد؟')...",
