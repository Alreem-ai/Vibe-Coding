  ...
  return (
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
        ...
        <div className="relative w-full">
          <div className="bg-cream border-3 border-ink rounded-lg p-6 shadow-retro w-full relative z-0">
             <div className="flex items-center gap-3 mb-3 border-b-2 border-ink/20 pb-2">
                <span className="bg-ink text-cream font-pixel text-xs px-2 py-1 border-2 border-ink" dir="ltr">MODULE_05</span>
             ...
             <h1 className="font-heading text-3xl md:text-4xl text-ink leading-tight">
               النشر والعرض النهائي (خلّها تشتغل فعليًا)
             </h1>
          </div>
        </div>
      </div>
      ...
      <div className="flex justify-between items-center mt-12 border-t-2 border-ink/20 pt-6">
        ...
        <Link href="/day/4" className="retro-btn bg-dusty-blue text-cream font-pixel text-xs py-3 px-6 border-3 border-ink rounded-xl shadow-retro hover:bg-dusty-blue-dark flex items-center gap-2 transition-transform hover:-translate-y-1">
