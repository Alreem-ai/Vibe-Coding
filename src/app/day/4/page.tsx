...
import { ArrowLeft, ArrowRight, Target, GitBranch, Cloud, Rocket, CheckCircle2, GitCommit, UploadCloud, MonitorPlay, Zap, Database, Server, GitMerge, PlayCircle, Link as LinkIcon, Lock } from "lucide-react";
import { curriculumData } from "@/data/curriculum";

export default function Day4Page() {
  const dayData = curriculumData.find((d) => d.id === 4);
  ...
  return (
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="flex justify-between items-center mt-12 border-t-2 border-ink/10 pt-6 max-w-4xl mx-auto flex-row-reverse">
        {/* Next Day Button (Day 5) */}
        {curriculumData.find(d => d.id === 5)?.isLocked ? (
