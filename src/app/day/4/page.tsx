  ...
  return (
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
        ...
        <div className="relative w-full">
          <div className="bg-cream border-3 border-ink rounded-lg p-6 shadow-retro w-full relative z-0">
             ...
             <h1 className="font-heading text-3xl md:text-4xl text-ink leading-tight">
               الاختبار الآلي وتصحيح الأخطاء (بالذكاء الاصطناعي)
             </h1>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-8 max-w-4xl mx-auto">
        <section className="relative">
          ...
          <div className="bg-sage-light/30 border-3 border-ink rounded-xl p-6 shadow-retro relative z-10 ml-2">
            ...
            <p className="font-body text-lg text-ink font-semibold leading-relaxed">
              ضمان جودة الكود المنتج واكتشاف الأخطاء وتصحيحها.
            </p>
          </div>
        </section>
        ...
        <section className="bg-ink rounded-xl border-4 border-ink shadow-retro-lg overflow-hidden flex flex-col">
          ...
          <div className="p-6 bg-ink text-sage font-mono text-sm sm:text-base leading-relaxed space-y-4">
            <div dir="ltr" className="text-dusty-blue mb-2">&gt; INIT MODULE_04...</div>
            
            <div className="flex items-start gap-3">
              <span className="text-mustard shrink-0 mt-1" dir="ltr">[1]</span>
              <p className="text-cream">توليد مجموعات اختبار، وتصحيح الأخطاء بمساعدة AI.</p>
            </div>
            <div className="flex items-start gap-3">
              <span className="text-mustard shrink-0 mt-1" dir="ltr">[2]</span>
              <p className="text-cream">سير عمل مراجعة الكود، والتحقق المستمر (linting/type-checking).</p>
            </div>
            <div className="flex items-start gap-3">
              <span className="text-mustard shrink-0 mt-1" dir="ltr">[3]</span>
              <p className="text-cream">بناء الثقة بالأدلة لا الافتراض.</p>
            </div>
      ...
      <div className="flex justify-between items-center mt-12 border-t-2 border-ink/20 pt-6">
        <Link href="/day/5" className="retro-btn bg-coral text-cream font-pixel text-xs py-3 px-6 border-3 border-ink rounded-xl shadow-retro hover:bg-coral-dark flex items-center gap-2 transition-transform hover:-translate-y-1">
          <ArrowRight size={16} /> <span className="mt-1">اليوم التالي</span>
        </Link>
        
        <Link href="/day/3" className="retro-btn bg-dusty-blue text-cream font-pixel text-xs py-3 px-6 border-3 border-ink rounded-xl shadow-retro hover:bg-dusty-blue-dark flex items-center gap-2 transition-transform hover:-translate-y-1">
